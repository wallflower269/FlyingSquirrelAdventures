...
public class Level1State extends GameState {
	...
	public void init() {
		...
		teleport.setPosition(3136, 183);  // vị trí của Teleport
	...
	private void checkPlayerStatus() {
		...
		if (player.isAtPosition(3141, 196)) {
		// if (player.isAtPosition(137, 196)) {
			gsm.setState(GameStateManager.LEVEL2STATE);     // chuyển trạng thái level2
		}
	...
	public void update() {
		...
		if (player.getHealth() <= 0) {
			gsm.setState(GameStateManager.GAMEOVERSTATE); // chuyển trạng thái Game Over
		}
